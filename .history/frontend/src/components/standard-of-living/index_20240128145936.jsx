        ...
        <MainContainer>
            ...
            <MidContainer>
                ...
                <Description>
                    ...
                    de la vecini care vor să te ajute. Acum T.R.A.I. înseamnă:<br></br>
                    <span style={styles}>T </span>– nivelul de trafic 
                    <span style={styles}>R</span> – densitatea reperelor (parcuri, restaurante etc.) 
                    <span style={styles}>A</span> – calitatea aerului 
                    <span style={styles}>I</span> – costul pe metru pătrat al imobiliarelor
