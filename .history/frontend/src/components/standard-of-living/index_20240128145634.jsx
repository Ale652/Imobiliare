        ...
        <MainContainer>
            ...
            <MidContainer>
                ...
                <Description>
                    ...
                    <span style={styles}></span>R</span> – densitatea reperelor (parcuri, restaurante etc.) 
                    <span style={styles}></span>A</span> – calitatea aerului 
                    <span style={styles}></span>I</span> – costul pe metru pătrat al imobiliarelor
