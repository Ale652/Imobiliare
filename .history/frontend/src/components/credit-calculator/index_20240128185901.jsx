import { ButtonCustonm, Title, MainContainer, MidContainer, MidContainerLarger, Description, Img, Section, Sun, Heart, DescriptionContainer, DescriptionTextContainer } from "./styles";
